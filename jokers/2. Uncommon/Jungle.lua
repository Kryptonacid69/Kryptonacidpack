SMODS.Joker {
	...
	config = { extra = { odds = 15, Xmult = 1, currentquip = 0, Xquips = { 'Meow!', 'Munch Munch Munch', 'The Fog is Coming', 'I am Literally scratching your furniture' }, TotalXMult = 1, XmultScaler = 0.1, UpgradeMult = 5 }, },
